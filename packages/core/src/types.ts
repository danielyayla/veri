...
export type Issue =
  ...
  // `stamped-backlog` (WO-111) retired with the ready state (DEC-143,
  // WO-143): a stamp on a backlog work order is now clearance granted but
  // not yet spent by dispatch — a legal state, not a contradiction.
