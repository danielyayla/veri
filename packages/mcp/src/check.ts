...
import { boundTests, buildCheckReport, loadProject, localToday } from '@verikb/core';
import type { CheckReport } from '@verikb/core';
import { collectTestFacts } from './facts.ts';
 ...
 * subprocess. Pure document checks and bound tests
