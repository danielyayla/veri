 ...
 * derivation the CLI prints, pure over the loaded corpus — receipts,
 * bindings, and the module registry are all document-recorded, so no git
 * tier is needed and DEC-081's no-subprocess posture holds.
 */
