...
- 2026-08-18 — e285d98 — packages/ui/src/renderer/palette.test.ts — Follow-up fix: the view-name test's row mapping now handles the overflow variant, restoring npm run typecheck
