...
- Compile-keeping map entries only in `packages/ui`, exactly as [[WO-121]] did
...
- Any surface for methods in `packages/ui` beyond what the compiler demands. The app is design-gated by [[DEC-012]] and needs a design document first
