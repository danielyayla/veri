...
- 2026-08-24 — d7ed0a1 — veri/decisions/DEC-067-import-instruction-package-is-a-get-import-instructions-mcp.md, veri/decisions/DEC-068-import-filing-surface-file-requirement-and-file-source-tools.md — DEC-067/068 approved by Daniel; live app walk via VERI_UI_SHOT against a scratch brownfield project verified all four surfaces plus derived review progress — all acceptance boxes checked, WO done.
