...
- 2026-09-02 — 5f9a4c7 — b6d17fd's schema repair left the bundled action dist stale; CI's freshness step caught it red on WO-155's bump push and the rebuild was committed under this work order's subject — receipt appended after WO-155's review found the commit unreceipted here (WF-001 rule 5).
