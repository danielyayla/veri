...
- 2026-08-24 — a205f7c — veri/work-orders/WO-081 — DEC-077 approved by Daniel (stamp commit e9540d6); acceptance box 1 checked. Sole remaining box: npm publish (scope claim + NPM_TOKEN + non-dry workflow run), so the WO stays in-progress.