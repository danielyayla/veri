...
- 2026-08-17 — fb5e3b6 — .github/workflows/release.yml, veri/decisions/DEC-032-ci-pre-creates-the-release-draft-before-electron-builder-pu.md — CI owns release create/upload, electron-builder builds with publish never (DEC-032 proposed); verified on v0.1.3 (acceptance run tagged from unprefixed version-bump commit ef01dd7) — one release, full asset set; verify step proven red on v0.1.2's split
- 2026-08-17 — veri/decisions/DEC-032-ci-pre-creates-the-release-draft-before-electron-builder-pu.md — DEC-032 approved by Daniel (lifecycle commit 8726e91 "DEC-032: approved"); v0.1.3 published as latest, DMG downloaded, mounted, and launch-verified; accidental commit of in-progress WO-030 files reverted off main in cleanup commit d72deb7
