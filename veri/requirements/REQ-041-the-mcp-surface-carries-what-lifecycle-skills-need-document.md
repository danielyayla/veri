...
Items 1–3 are read-only additions with no promotion-boundary risk. Item 4 touches the boundary itself and must not ship without a decision recording how the user's act stays the user's.
